...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RentPost.cat'
        db.add_column(u'posts_rentpost', 'cat',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['categories.Category']),
                      keep_default=False)

        # Adding field 'SalePost.cat'
        db.add_column(u'posts_salepost', 'cat',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['categories.Category']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RentPost.cat'
        db.delete_column(u'posts_rentpost', 'cat_id')

        # Deleting field 'SalePost.cat'
        db.delete_column(u'posts_salepost', 'cat_id')
