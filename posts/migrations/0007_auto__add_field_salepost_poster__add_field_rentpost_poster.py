...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SalePost.poster'
        db.add_column(u'posts_salepost', 'poster',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'RentPost.poster'
        db.add_column(u'posts_rentpost', 'poster',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SalePost.poster'
        db.delete_column(u'posts_salepost', 'poster_id')

        # Deleting field 'RentPost.poster'
        db.delete_column(u'posts_rentpost', 'poster_id')
