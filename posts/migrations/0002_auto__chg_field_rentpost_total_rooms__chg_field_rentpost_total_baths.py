...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'RentPost.total_rooms'
        db.alter_column(u'posts_rentpost', 'total_rooms', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1))

        # Changing field 'RentPost.total_baths'
        db.alter_column(u'posts_rentpost', 'total_baths', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1))
    ...
    models = {
        ...
        u'posts.rentpost': {
            ...
            'total_baths': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'total_rooms': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
