...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'posts_rentpost', 'total_rooms', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

        # Changing field 'RentPost.total_baths'
        db.alter_column(u'posts_rentpost', 'total_baths', self.gf('django.db.models.fields.SmallIntegerField')(null=True))
